...
try:
    ...
    audit=r'''(async()=>{
      ...
      for(let run=1;run<=20;run++){window.__progress='run-'+run;
        ...
        ok('Versão carregada',MarcoV256.version==='2.5.9'&&MarcoV259.version==='2.5.9');
    ...
    out=ROOT/'RESULTADO_NAVEGADOR_20X_V2_5_9.json';out.write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
