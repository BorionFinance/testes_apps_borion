(() => {
  ...
  const FIELD_DEFS=[
    ['clientField','Cliente','client-selector',24,24,560,74,280,58,false,true],
    ['equipmentField','Equipamento','equipment-selector',600,24,560,74,250,58,false,true],
    ['openedAtField','Data de abertura','date',24,126,260,64,160,52,false,true],
    ['completedAtField','Data de conclusão','date',300,126,260,64,160,52,false,false],
    ['statusField','Status operacional','select',576,126,280,64,180,52,false,true],
    ['brandModelField','Marca / Modelo','text',872,126,288,64,200,52,false,false],
    ['serialNumberField','Número de série','text',24,218,260,64,180,52,false,false],
    ['accessPasswordField','Senha de acesso','text',300,218,260,64,180,52,false,false],
    ['accessoriesField','Acessórios deixados','text',576,218,584,64,240,52,false,false],
    ['reportedIssueField','Defeito relatado','textarea',24,316,560,126,300,88,true,true],
    ['technicalReportField','Laudo técnico','textarea',600,316,560,126,300,88,true,false],
    ['clientNotesField','Observações para o cliente','textarea',24,482,560,114,300,84,true,false],
    ['internalNotesField','Observação interna','textarea',600,482,560,114,300,84,true,false],
  ...
  const CLIENT_FIELD_DEFS=[
    ['identifier','Identificador do cliente','identifier',16,16,1168,64,220,52,true,true],
    ['name','Nome','text',16,104,1168,68,220,54,true,true],
    ['phone','Telefone','tel',16,202,568,68,180,54,true,false],
    ['document','CPF/CNPJ','text',600,202,584,68,180,54,true,false],
    ['address','Rua / Endereço','text',16,300,760,68,240,54,true,false],
    ['zip','CEP','text',792,300,392,68,160,54,true,false],
    ['addressTools','Busca de endereço e resultados','dynamic-section',16,398,1168,118,300,88,true,false],
    ['number','Número','text',16,532,240,68,140,54,true,false],
    ['city','Cidade','text',272,532,456,68,180,54,true,false],
    ['state','Estado','select',744,532,184,68,120,54,true,false],
    ['neighborhood','Bairro','text',944,532,240,68,160,54,true,false],
    ['complement','Complemento','text',16,630,568,68,180,54,true,false],
    ['notes','Observação interna','textarea',600,630,584,116,260,82,true,false],
    ['actions','Ações do formulário','actions',16,778,1168,82,360,66,true,true]
  ];
